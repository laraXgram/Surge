...
namespace LaraGram\Surge\Commands\Writer;

use Closure;
use LaraGram\Surge\Commands\Writer\Contracts\RenderableOnWriterEditor;
use LaraGram\Surge\Commands\Writer\Contracts\RenderlessEditor;
use LaraGram\Surge\Commands\Writer\Contracts\RenderlessTrace;
use LaraGram\Surge\Commands\Writer\Contracts\SolutionsRepository;
use LaraGram\Surge\Commands\Writer\SolutionsRepositories\NullSolutionsRepository;
...
final class Writer
{
    ...
    public function write(Inspector $inspector): void
    {
        ...
        if ($exception instanceof RenderableOnWriterEditor) {
            $editorFrame = $exception->toWriterEditor();
        } else {
