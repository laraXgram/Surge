...
class ApplicationFactory
{
    ...
    {
        $paths = [
            $this->basePath.'/.laragram/app.php',
        ...
        throw new RuntimeException("Application bootstrap file not found in 'bootstrap' or '.laragram' directory.");
    }
    ...
    {
        foreach ($services ?: $app->make('config')->get('surge.warm', []) as $service) {
